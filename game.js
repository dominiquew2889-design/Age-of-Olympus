const SAVE_KEY="ageOfOlympusSaveV190";
...
function ensureV190Data(){
 if(!state.v190)state.v190={fates:[],houseRelations:[],succession:[],artifactHistory:[],expeditions:[],lifeEvents:[],legacyRegistry:v190LegacyRegistry.map(x=>({...x})),version:"1.9.0"};
