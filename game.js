const SAVE_KEY="ageOfOlympusSaveV180";
...
function patchStage11Navigation(){
 const map=window.__navCategoryMap;if(!map)return;
 if(map.chronicle&&!map.chronicle.items.some(x=>x[0]==="system-core-view"))map.chronicle.items.push(["system-core-view","🔧","Olympus Core","Integrity & unified records"]);
}
