const SAVE_KEY="ageOfOlympusSaveV130S2";
...
function advanceYear(){
 ...
 const income=calculateYearlyIncome();state.gold+=income.total;recordGold(income.total,"Yearly income");resolveEnterprises();resolveFleetYear();wonderYearTurn();resolveTrainingYear();cityYearTurn();kingdomYearTurn();civilizationYearTurn();autonomousHeroYearTurn();bloodlineYearTurn();divineFamilyYearTurn();divinePoliticsYearTurn();titanCouncilYearTurn();avatarYearTurn();livingOlympusYearTurn();fateYearTurn();miracleYearTurn();worldSimulationTurn();
 state.cities.forEach(c=>{
