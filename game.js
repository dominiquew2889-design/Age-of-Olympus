const SAVE_KEY="ageOfOlympusSaveV140S6";
...
function renderGodSelection(){
 ...
 if(localStorage.getItem(SAVE_KEY)||localStorage.getItem(PREVIOUS_SAVE_KEY_STAGE6))$("#continue-button").classList.remove("hidden");
}
