const SAVE_KEY="ageOfOlympusSaveV140S4";
...
function initNavigationV2(){
 ...
 window.__navCategoryMap={
  ...
  chronicle:{title:"Chronicle",items:[["library-view","📚","Library","Library of Fate"],["history-view","📜","History","World chronicle"],["legacy-view","🏺","Legacy","Generational records"],["reputation-view","👁️","Reputation","How the world sees you"],["ages-view","⏳","Ages","World eras"]]},
